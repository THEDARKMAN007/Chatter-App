...
export const LandingPage = () => {
  return (
    <div className='text-[#111]'>
      ...
      <main>
        <section className='py-[216px] px-[228px] text-[#FFF] bg-cover bg-center bg-no-repeat opacity-100' style={{backgroundImage:"url('/src/assets/images/landing-page/chatter-hero-img.jpg')",
}}>
        ...
        <section className='text-[#111] flex flex-col sm:w-[90%] sm:mx-auto sm:flex-row sm:justify-between sm:mt-[6.67vw]'>
        ...
        <section className='sm:w-[74.28%] sm:mx-auto sm:mt-[6.66vw]'>
          ...
          <ul className='flex flex-col sm:flex-row sm:items-start sm:justify-between'>
            <li className='sm:w-[29.4%] border rounded-[0.44em] border-[#D0D0D0] sm:py-[1.04vw] sm:px-[1.25vw] sm:flex sm:flex-col sm:gap-[0.83vw]'>
              <img src={analyticIcon} alt="analytics-icon" className='sm:w-[6.4vw] sm:h-[6.11vw]'/>
              <h3 className='font-[500] sm:text-[1.67vw] leading-[1.5em]'>Analytics</h3>
            ...
            <li className='sm:w-[29.4%] border rounded-[0.44em] border-[#D0D0D0] sm:py-[1.04vw] sm:px-[1.25vw] sm:flex sm:flex-col sm:gap-[0.83vw]'>
              <img src={socialIntIcon} alt="social-interaction-icon" className='sm:w-[6.4vw] sm:h-[6.11vw]'/>
              <h3 className='font-[500] sm:text-[1.67vw] leading-[1.5em]'>Social interactions</h3>
              <p className='font-[400] leading-[1.5em] sm:text-[1.25vw] text-[#626262]'>
                Users on the platform can interact with posts they like, comment and engage in discussions
              </p>
            </li>
            <li className='sm:w-[29.4%] border rounded-[0.44em] border-[#D0D0D0] sm:py-[1.04vw] sm:px-[1.25vw] sm:flex sm:flex-col sm:gap-[0.83vw]'>
              <img src={contCreatIcon} alt="cont-creation-icon" className='sm:w-[6.4vw] sm:h-[6.11vw]'/>
              <h3 className='font-[500] sm:text-[1.67vw] leading-[1.5em]'>Content creation</h3>
              <p className='font-[400] leading-[1.5em] sm:text-[1.25vw] text-[#626262]'>
        ...
        <section className='mt-[7.43vw] bg-[#FFEDCC80] flex flex-col sm:flex-row sm:gap-[1.8vw] py-[3.61vw] px-[3.68vw] text-[#111]'>
            <img src={softwareEng} alt='software engineer at apple' className='sm:w-[25vw] sm:h-[25vw]'/>
          <div className='flex flex-col'>
            ...
            <cite className='font-[500] sm:text-[1.67vw] leading-[1.5em] sm:mb-[1em]'><b>Adebobola Muhydeen,</b> Software developer at Apple </cite>
            <button type='button' className='sm:w-[17%] sm:text-[1.25vw] font-[700] px-[0.89em] py-[0.44em]  leading-[1.5em] rounded-[0.44em] text-[#FFF] bg-[#543EE0]'>Join chatter</button>
          </div>
        </section>
        <section className='sm:w-[78.26%] sm:mx-auto sm:flex sm:flex-row sm:justify-between sm:my-[6.67vw]'>
          <div className='sm:w-[31.2%] text-center flex flex-col'>
            <img src={pic1} alt='pic1' className='sm:rounded-[100%] sm:w-[11.7vw] sm:h-[11.7vw]'/>
            <img src={pic2} alt='pic2' className='sm:rounded-[100%] sm:w-[11.7vw] sm:h-[11.7vw] sm:self-end'/>
            <img src={pic3} alt='pic3' className='sm:rounded-[100%] sm:w-[11.7vw] sm:h-[11.7vw]'/>
          </div>
          <div className='sm:w-[58.2%]'>
            <h1 className='sm:text-[3.33vw] sm:pb-[0.5em] leading-[1.5em] font-[700]'>Write, read and connect with great minds on chatter</h1>
            ...
            <button type='button' className='sm:w-[24%] sm:text-[1.25vw] font-[700] px-[0.89em] py-[0.44em]  leading-[1.5em] rounded-[0.44em] text-[#FFF] bg-[#543EE0]'>Get started</button>
          </div>
        </section>
      </main>
      <footer className='bg-[#FFEDCC80] flex sm:flex-row sm:justify-around'>
        <h1 className='text-[#543EE0] font-[700] leading-[1.5em] sm:text-[max(3.33vw)]'>
          CHATTER
        </h1>
        <div>
