...
export const ConfirmationPage = () => {
  ...
  const formData:SubmitHandler<Inputs> = (data) => {console.log(data)}
  return (
    <>
      <p>
      ...
      <form action='GET' onSubmit={handleSubmit(formData)}>
        ...
        <input type='number' {...register('three', { required: true, max:1})}/>
        <input type='number' {...register('four', { required: true, max:1})}/>
